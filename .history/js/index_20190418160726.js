...
function getWeekByDay(str) {
    ...
    var times = date.getTimes();
    var day = date.getDay();// 0 - 6
    //[day - n*24*60*60*1000,day + (6-n)*24*60*60*1000)]
    var start = timeToDateStr(times - day*24*60*60*1000);
    var end = timeToDateStr(times + (6-day)*24*60*60*1000);
    return [start,end];
}
