    ...
    created() {
        $.ajax({
            ...
            success: (res) => {
                ...
                res.data.intergral.phraise = res.data.intergral.login;
                res.data.intergral.post = res.data.intergral.login;
                res.data.intergral.intergrals = res.data.intergral.login;
