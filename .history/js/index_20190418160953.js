...
function getWeekByDay(str) {
    ...
    //[day - (n+1)*24*60*60*1000,day + (7-n)*24*60*60*1000)]
    var start = timeToDateStr(times - (day-1)*24*60*60*1000);
    var end = timeToDateStr(times + (7-day)*24*60*60*1000);
    return [start,end];
}
...
initCalendar();
console.log(getWeekByDay('2019/4/15'));
