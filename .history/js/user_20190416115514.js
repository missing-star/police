...
var xm = new Vue({
    ...
    created() {
        $.ajax({
            ...
            dataType: 'json',
            success: (res) => {
                res.data.intergral.login = res.data.intergral.login == null ? 0 : res.data.intergral.login;
                res.data.intergral.phraise = res.data.intergral.phraise == null ? 0 : res.data.intergral.phraise;
                res.data.intergral.post = res.data.intergral.post == null ? 0 : res.data.intergral.post;
                res.data.intergral.intergrals = res.data.intergral.intergrals == null ? 0 : res.data.intergral.intergrals;
                this.titleList = res.data.post
