				...
				yesBtn : {
					...
					click : function(e) {
						...
						if (rows == 0 || !/^\d+$/.test(rows)) {
							warn.alert(self.lang('invalidRows'));
							rowsBox[0].focus();
							return;
						}
						...
						if (!/^\d*$/.test(width)) {
							warn.alert(self.lang('invalidWidth'));
							widthBox[0].focus();
							return;
						}
						if (!/^\d*$/.test(height)) {
							warn.alert(self.lang('invalidHeight'));
							heightBox[0].focus();
							return;
						}
						if (!/^\d*$/.test(padding)) {
							warn.alert(self.lang('invalidPadding'));
							paddingBox[0].focus();
							return;
						}
						if (!/^\d*$/.test(spacing)) {
							warn.alert(self.lang('invalidSpacing'));
							spacingBox[0].focus();
							return;
						}
						if (!/^\d*$/.test(border)) {
							warn.alert(self.lang('invalidBorder'));
							borderBox[0].focus();
							return;
						}
						//modify table
